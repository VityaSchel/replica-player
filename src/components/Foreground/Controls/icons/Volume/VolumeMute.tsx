...
export default function VolumeMute(props: { muted: boolean }) {
  const clipPathStyle = cx(styles.clipPath, { [styles.muted]: props.muted })
  ...
  return (
    <svg height='100%' version='1.1' viewBox='0 0 36 36' width='36'>
      ...
      <path className='ytp-svg-fill ytp-svg-volume-animation-speaker' clipPath='url(#ytp-svg-volume-animation-mask)'
        d='' //animation is here
